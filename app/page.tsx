    ...
    <>
      ...
      <section className="cli-section">
        <div className="cli-section-inner">
          ...
          <Row className="gx-0 mb-3">
            <Col xs={12}>
              <p className="cli-intro">
                Lightweight Rust music player that turns any file into a
                chiptune right in your terminal. Feed it a binary, an
                executable, a document — anything. The file name and bytes are
                used as a deterministic seed: same input always produces the
                same tune.
                <br />
          ...
          <Row className="gx-0 mb-3">
            <Col xs={12}>
              <p className="cli-features-label">FEATURES</p>
              <Row as="ul" xs={1} md={3} className="g-2 cli-feature-list">
                <Col as="li">
                ...
                <Col as="li">
                  <div className="cli-feature-card">
                    Visualize
                    <br />
                    Awesome square + triangle + noise waves render
                  </div>
                </Col>
                <Col as="li">
                  <div className="cli-feature-card">
